...
public class Command {
    ...
    public Command(int numcn, int uid, double weighttotal, double weightpervolume, double volume, double weightreal, double amountlivraison, double declaredprice, int logisticsnum, User user, String description, String statuspayment, String depotname, String typetransport, String service, String insurance, String time) {
        this.numcn = numcn;
        this.uid = uid;
        this.weighttotal = weighttotal;
        this.weightpervolume = weightpervolume;
    ...
    public Command(int numcn, int cid, int uid, double weighttotal, double weightpervolume, double volume, double weightreal, double amountlivraison, double declaredprice, int logisticsnum, User user, String description, String statuspayment, String depotname, String typetransport, String service, String insurance, String time) {
        this.numcn = numcn;
        this.cid = cid;
        this.uid = uid;
        this.weighttotal = weighttotal;
