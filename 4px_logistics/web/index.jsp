                ...
                <ul id="nav">
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('会员列表(静态表格)','UserController/findAll')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>会员列表</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('会员列表(静态表格)','/AdressController/findAll')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>地址列表</cite></a>
                            </li>
                               <li>
                                <a onclick="xadmin.add_tab('会员列表(静态表格)','bon-list.jsp')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>优惠券列表</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('订单列表1','order-list1.jsp')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>包裹列表</cite></a>
                            </li>
                        </ul>
