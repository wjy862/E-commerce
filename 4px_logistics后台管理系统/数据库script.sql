...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 03 juil. 2020 à 13:31
...
CREATE TABLE `command` (
  `numcn` int(20) NOT NULL COMMENT '运单号\r\n',
  `cid` int(11) NOT NULL,
  `time` varchar(30) NOT NULL COMMENT '预报时间\r\n',
  `weighttotal` decimal(7,2) NOT NULL COMMENT '重量\r\n',
  `weightpervolume` decimal(7,2) NOT NULL COMMENT '体积重\r\n',
  `volume` decimal(7,2) NOT NULL COMMENT '体积\r\n',
  `weightreal` decimal(7,2) NOT NULL COMMENT '计费重量\r\n',
  `amountlivraison` decimal(7,2) NOT NULL COMMENT '运费\r\n',
  `declaredprice` decimal(7,2) NOT NULL COMMENT '申报价格\r\n',
  `description` varchar(500) NOT NULL COMMENT '费用明细\r\n',
  `statuspayment` varchar(11) NOT NULL COMMENT '支付状态\r\n',
  `depotname` varchar(20) NOT NULL COMMENT '转运仓名\r\n',
  `logisticsnum` int(11) NOT NULL COMMENT '中国物流单号\r\n',
  `typetransport` varchar(20) NOT NULL COMMENT '转运方式\r\n物流服务\r\n',
  `service` varchar(20) NOT NULL COMMENT '物流服务\r\n\r\n',
  `insurance` varchar(20) NOT NULL COMMENT '增值服务（保险）',
  `uid` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `user` (`uid`, `uname`, `telephone`, `photo`, `mail`, `gender`, `birthday`, `currentbalance`, `rebate`, `pwd`) VALUES
(1, 'wu', 650385625, '1.jsp', 'vfdv@gmao.com', 'homme', '01-09-2020', 300, 20, 123),
(2, 'zs', 650385625, NULL, 'leowjy123456@gmail.com', 'homme', '01-09-2020', 300, 20, 123),
(3, 'wjy', 159364, NULL, 'fsfsdfvdx', 'homme', '01-09-2019', 500, 124, 123),
(4, '张三', 650385625, 'iphone-免费墙纸图像电话-梦想精致的-电池壁纸免费下载-86.jpg', 'leowjy123456@gmail.com', 'homme', '01-09-2020', 300, 20, 123),
(5, 'wjy', 159364, NULL, 'fsfsdfvdx', 'homme', '01-09-2019', 500, 124, 123),
(6, 'wjy', 159364, 'WeChat Image_20200605170533.png', 'dfgdfvdfvdfvdf', 'homme', '01-09-2019', 500, 124, 123),
(7, 'zs', 650385625, 'iphone-免费墙纸图像电话-梦想精致的-电池壁纸免费下载-86.jpg', 'leowjy123456@gmail.com', 'homme', '01-09-2020', 300, 20, 123);
